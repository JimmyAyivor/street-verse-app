                ...
                <div className="flex">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-2 text-[20px] font-['Play'] text-gray-500">
                      ...
                      makes banknotes ‘fungible’. A Non-Fungible Token (NFT) is
                      different because it’s not interchangeable. Each one is
                      unique, like a one-of-a-kind trading card or ultra-rare
                      pair of Jordans.
                    </p>
                  </div>
                </div>
                  ...
                  <div className="flex">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="mt-2 text-[20px] font-['Play'] text-gray-500">
                        ...
                        semi-annual fashion shows in some of the most intriguing
                        corners of the world. We’ll be there. Will you?
                      </p>
                    </div>
                  </div>
                  <div className="flex">
